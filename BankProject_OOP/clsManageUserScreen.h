...
private:
    ...
    {
        clsUserScreens::ShowUsersList();
    }

    static void _ShowAddNewUserScreen()
    {
        clsUserScreens::ShowAddNewUserScreen();
    }

    static void _ShowDeleteUserScreen()
    {
        clsUserScreens::ShowDeleteUserScreen();
    }

    static void _ShowUpdateUserScreen()
    {
        clsUserScreens::ShowUpdateUserScreen();
    }

    static void _ShowFindUserScreen()
    {
        clsUserScreens::ShowFindUserScreen();
    }
